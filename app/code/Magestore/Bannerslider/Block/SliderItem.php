...
class SliderItem extends \Magento\Framework\View\Element\Template
{
     ...
     */
    const STYLESLIDE_EVOLUTION_TEMPLATE = 'Magento_Theme::banner_slider/slider/evolution.phtml';

    /**
     * template for popup.
     */
    const STYLESLIDE_POPUP_TEMPLATE = 'Magento_Theme::banner_slider/slider/popup.phtml';

    /**
     * template for note slider.
     */
    const STYLESLIDE_SPECIAL_NOTE_TEMPLATE = 'Magento_Theme::banner_slider/slider/special/note.phtml';

    /**
     * template for flex slider.
     */
    const STYLESLIDE_FLEXSLIDER_TEMPLATE = 'Magento_Theme::banner_slider/slider/flexslider.phtml';

    /**
     * template for custom slider.
     */
    const STYLESLIDE_CUSTOM_TEMPLATE = 'Magento_Theme::banner_slider/slider/custom.phtml';
