...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function getBannerCollection($sliderId)
    {
        ...
        $bannerCollection = $this->setStoreViewId($storeViewId)
            ...
            /*$bannerCollection->addFieldToFilter(['start_time', 'end_time', 'start_time' , 'end_time'],
                [
                    ['null' => true],
                    ['null' => true],
                    ['lteq' => $dateTimeNow],
                ...
                /*AND ((`start_time` IS NULL) OR (`end_time` IS NULL) OR (`start_time` <= '2017-09-22 09:08:52') OR (`end_time` >= '2017-09-22 09:08:52'))*/

            $bannerCollection->getSelect()->where("((start_time IS NULL) AND (end_time IS NULL)) OR ((`start_time` <= '".$dateTimeNow."') AND (`end_time` >= '".$dateTimeNow."'))");
