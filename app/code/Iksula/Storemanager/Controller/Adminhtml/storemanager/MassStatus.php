...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('storemanager');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Iksula\Storemanager\Model\Storemanager')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('storemanager/*/index');
    }
