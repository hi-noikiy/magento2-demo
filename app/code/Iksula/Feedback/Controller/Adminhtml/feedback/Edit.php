...
namespace Iksula\Feedback\Controller\Adminhtml\feedback;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Iksula_Feedback::Feedback')
            ->addBreadcrumb(__('Iksula Feedback'), __('Iksula Feedback'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Iksula\Feedback\Model\Feedback');
        ...
        $this->_coreRegistry->register('feedback', $model);
