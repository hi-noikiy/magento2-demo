...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Iksula_Feedback';
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('feedback')->getId()) {
            return __("Edit Feedback '%1'", $this->escapeHtml($this->_coreRegistry->registry('feedback')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('feedback/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
