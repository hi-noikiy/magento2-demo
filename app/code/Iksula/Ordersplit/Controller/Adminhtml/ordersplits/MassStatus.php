...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('ordersplits');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Iksula\Ordersplit\Model\Ordersplits')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('ordersplit/*/index');
    }
