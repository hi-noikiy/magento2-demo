...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Iksula_Ordersplit::Ordersplits')
            ->addBreadcrumb(__('Iksula Ordersplit'), __('Iksula Ordersplit'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Iksula\Ordersplit\Model\Ordersplits');
        ...
        $this->_coreRegistry->register('ordersplits', $model);
